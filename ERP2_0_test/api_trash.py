...
class EntEquimentResource(MyModelTrashResource):
    class Meta:
        queryset = dbModels.EntEquipment.objects.all().order_by('-d_time', 'id')
...
class EntItemResource(MyModelTrashResource):
    class Meta:
        queryset = dbModels.EntItem.objects.all().order_by('-d_time', 'id')
...
class EntMachineResource(MyModelTrashResource):
    class Meta:
        queryset = dbModels.EntMachine.objects.all().order_by('-d_time', 'id')
...
class EntMaterialResource(MyModelTrashResource):
    class Meta:
        queryset = dbModels.EntMaterial.objects.all().order_by('-d_time', 'id')
...
class EntOrderResource(MyModelTrashResource):
    class Meta:
        queryset = dbModels.EntOrder.objects.all().order_by('-d_time', 'id')
...
class EntRelItemItemResource(MyModelTrashResource):
    class Meta:
        queryset = dbModels.EntRelItemItem.objects.all().order_by('-d_time', 'id')
...
class EntRelMathineItemResource(MyModelTrashResource):
    class Meta:
        queryset = dbModels.EntRelMachineItem.objects.all().order_by('-d_time', 'id')
...
class EntRelStorageItemResource(MyModelTrashResource):
    class Meta:
        queryset = dbModels.EntRelStorageItem.objects.all().order_by('-d_time', 'id')
...
class EntRelTechnologyItemEquipmentResource(MyModelTrashResource):
    class Meta:
        queryset = dbModels.EntRelTechnologyItemEquipment.objects.all().order_by('-d_time', 'id')
...
class EntSotrageResource(MyModelTrashResource):
    class Meta:
        queryset = dbModels.EntStorage.objects.all().order_by('-d_time', 'id')
...
class EntTechnologyResource(MyModelTrashResource):
    class Meta:
        queryset = dbModels.EntTechnology.objects.all().order_by('-d_time', 'id')
...
class TmpItemFullRelResource(MyModelTrashResource):
    class Meta:
        queryset = dbModels.TmpItemFullRel.objects.all().order_by('-d_time', 'id')
