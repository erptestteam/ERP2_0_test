# Django settings for ERP2_0_test project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'erp2_3',  # Or path to database file if using sqlite3.
...
SECRET_KEY = '^msvn^lg4ngb#7w%s)+c*zqr(b(uwp%ta26=z=xu%d28!v#ol6'
...
ROOT_URLCONF = 'ERP2_0_test.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'ERP2_0_test.wsgi.application'
