...
DROP PROCEDURE IF EXISTS `top_component_disassemble2_2`$$

CREATE DEFINER=`root`@`%` PROCEDURE `top_component_disassemble2_2`(IN _useActualStorage INT,IN _useFutureStorage INT,
