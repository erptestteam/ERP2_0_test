...
DROP PROCEDURE IF EXISTS `order_analysis2`$$

CREATE DEFINER=`root`@`%` PROCEDURE `order_analysis2`(IN _useActualStorage INT,IN _useFutureStorage INT)
BEGIN
    ...
    WHILE _found DO
        ...
        CALL top_component_disassemble2(_useActualStorage,_useFutureStorage,_orderID,_componentID,_p,_c,
