...
DROP PROCEDURE IF EXISTS `order_analysis4`$$

CREATE DEFINER=`root`@`%` PROCEDURE `order_analysis4`(IN _useExpand INT,IN _useActualStorage INT,IN _useFutureStorage INT)
BEGIN
    ...
    WHILE _found DO
        ...
        if _useExpand = 0 then
            ...
            CALL top_component_disassemble3(_useActualStorage,_useFutureStorage,_orderID,_componentID,_p,_c,
        ...
        elseif _useExpand =1 then
            ...
            actualStorage,usedStorage,futureStorage,fromStorage,fromProduct) 
            VALUES (_orderID,_componentID,_p,_c,_orderRequirement,0,0,_defectRequirement,
        ...
        */
        ...
        IF _useExpand = 0 THEN
            ...
            VALUES (_orderID,_componentID,_p,_c,_orderRequirement,0,0,_defectRequirement,
            _actualStorage,_futureStorage,_usedStorage,_fromStorage,_fromProduct);
            CALL order_disassemble4(_useActualStorage,_useFutureStorage,_orderID,_componentID,_p,_c,
