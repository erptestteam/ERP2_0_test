...
var entity_edit_model  = {
    ...
    dispaly_columns:
    	...
    	[
              { display: '部品编号', name: 'item_number', width: 100, type: 'int' },
              {
					display : '仓库位置',
					name : 'storage_id',
					type:'int',
              ...
              {
                  display: '出入库数量', name: "count", width: 100
              },
              {
                  display: '出入库状态', name: 'type', width: 100
              },
              {
                  display: '部品类型', name: 'item_type', width: 100
              },
              {
